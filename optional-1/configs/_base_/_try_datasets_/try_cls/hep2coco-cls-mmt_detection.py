...
# python ./tools/dataset_converters/root_to_json.py --srcfile "./data/BESIII_training_sample/Lmdm_1m.root" --destroot "./data/HEP2COCO/"
# 
# cd ./data/HEP2COCO/bbox_scale_10/
# mkdir valset_NmLmdm
# cp   Nm_1m__b00000001__e00100000.json valset_NmLmdm/
# cp Lmdm_1m__b00000001__e00100000.json valset_NmLmdm/
# cd ../../../
# 
...
ann_files=[
  ...
  'Lmdm_1m__b00100001__e01200000.json',
  'Lmdm_1m__b00200001__e01300000.json',
  'Lmdm_1m__b00300001__e01400000.json',
  'Lmdm_1m__b00400001__e01500000.json']
