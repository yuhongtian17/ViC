...
# python ./vheat_pth_tools/interpolate4downstream.py --pt_pth "./data/pretrained/vHeat_tiny.pth" --tg_pth "./data/pretrained/vheat_tiny_512.pth"
# python ./vheat_pth_tools/interpolate4downstream.py --pt_pth "./data/pretrained/vHeat_small.pth" --tg_pth "./data/pretrained/vheat_small_512.pth"
# python ./vheat_pth_tools/interpolate4downstream.py --pt_pth "./data/pretrained/vHeat_base.pth" --tg_pth "./data/pretrained/vheat_base_512.pth"
